...
const ChooseThumbnailView = ({
  illust,
  onSelectThumbnail,
}: ChooseThumbnailViewProps) => {
...
const ThumbnailOption = styled.TouchableOpacity`
  ...
  border-width: ${(props: {isSelected: boolean}) =>
    props.isSelected ? scale(2) : scale(1)}px;
  border-color: ${(props: {isSelected: boolean}) =>
    props.isSelected ? COLORS.primary : COLORS.background.lightGray};
